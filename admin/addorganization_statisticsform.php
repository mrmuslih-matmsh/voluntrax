...
if (isset($_POST['save'])) {
    ...
    $qry = "INSERT INTO organization_statistics (total_hours, opportunities_completed, impact_achieved, last_updated, org_id) VALUES (?, ?, ?, CURRENT_TIMESTAMP, ?)";
  
    // Prepare the statement
    $stmt = $connection->prepare($qry);
  
    // Bind parameters
    $stmt->bind_param("isss", $totalh, $oppc, $impacta, $orgid);
...
<div class="max-w-md mx-auto bg-white rounded p-6 shadow-md flex flex-col items-center">
    <h2 class="text-2xl font-semibold mb-4">Add Organization Statistics</h2>
